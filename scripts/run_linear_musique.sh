#!/usr/bin/env bash
# End-to-end patched-LinearRAG run on MuSiQue: gold, arms, score.
#
...
#
#     PY39=~/.venv39/bin/python bash scripts/run_linear_musique.sh
set -euo pipefail

OURS=musique          # our dataset name (data/, out/)
THEIRS=musique        # their bundle directory name
DEVICE=${DEVICE:-3}
TOPK=${TOPK:-10}
